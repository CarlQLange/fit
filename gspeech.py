...
def send(filestr):
	with open(filestr, 'rb') as file:
		...
		try:
			...
			url = urllib.request.Request("https://www.google.com/speech-api/v1/recognize?xjerr=1&client=chromium&lang=en-US", audio)
...
def hear():
	subprocess.call("rec -r 16000 -c 1 out.flac silence 0 1 0:00:03 2%", shell=True)
	return("out.flac")